<%-- 
    Document   : cda_gene
    Created on : Jun 14, 2016, 10:50:56 AM
    Author     : java4
--%>
...
<body>
        ...
        %>
        <script>alert('This file Already Integrated');</script>
        <%
            }
        %>
		...
		<nav>
	      <%---menu start ---%>		
    			<ul class="sf-menu dropdown">
            			...
            			<li class="selected"><a href="cda_gene.jsp">CDA Generated</a></li>
...
<!--                    <div style="border: 1px solid white;height: 350px;border-top-width: 20px;border-bottom-width: 10px">-->
                        <center><h3>Patient Report</h3></center><br />
                        <table border="1" style="text-align: center;margin-left: 0px">
                            <tr>
                                ...
                                <th style="text-align: center;width: 30px;">Email</th>
                                <th style="text-align: center;width: 300px;">Patient Name</th>
                   ...
                   <td> <a href="view_file3.jsp?<%=rs.getString("pmail")%>"><font style="color: green">View</a></font> </td>
