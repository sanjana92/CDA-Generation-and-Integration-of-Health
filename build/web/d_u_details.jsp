<%-- 
    Document   : d_u_details
    Created on : Jun 14, 2016, 4:16:23 PM
    Author     : java4
--%>
		...
		<nav>
	      <%---menu start ---%>		
    			<ul class="sf-menu dropdown">
            			...
            			<li class="selected"><a href="d_u_details.jsp">Doctor and User details</a></li>
                                <li><a href="doc_req.jsp">Doctor Request</a></li>
...
<center><h5><font style="color: #0092D1">Doctor and User details</font></h5></center><br />
                        <table border="1" style="text-align: center;margin-left: 0px">
                            <tr>
                                ...
                                <th style="text-align: center;width: 300px;">Phone Number</th>
