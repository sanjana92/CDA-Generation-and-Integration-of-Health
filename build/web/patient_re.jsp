<%-- 
    Document   : patient_re
    Created on : Jun 14, 2016, 3:15:08 PM
    Author     : java4
--%>
		...
		<nav>
	      <%---menu start ---%>		
    			<ul class="sf-menu dropdown">
                                <li><a href="doc_home.jsp">Doctor Home</a></li>
            			<li class="selected"><a href="patient_re.jsp">Patient Information</a></li>
...
<center><h5><font style="color: #0092D1 ">Patient Report</font></h5></center><br />
                   ...
                   <td> <a href="request.jsp?<%=rs.getString("pmail")%>"><font style="color: green">Send</a></font> </td>
