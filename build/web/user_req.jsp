<%-- 
    Document   : user_req
    Created on : Jun 16, 2016, 3:29:49 PM
    Author     : java4
--%>
	      ...
	      <%---menu start ---%>		
    			<ul class="sf-menu dropdown">
            			...
            			<li><a href="d_u_details.jsp">Doctor and User details</a></li>
                                ...
                                <li class="selected"><a href="user_req.jsp">User Request</a></li>
                            ...
                            <tr>
                                <%
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from request where status='No' AND role='user'");
                                        while(rs.next())
