<%-- 
    Document   : view_ra
    Created on : Jun 11, 2016, 11:37:57 AM
    Author     : java4
--%>
	...
	<div class="width"><br>
		...
		<nav>
	      <%---menu start ---%>		
				...
				<li class="selected"><a href="view_ra.jsp">View Report</a></li>
...
<center><h5><font style="color: #0092D1 ">Patient Report</font></h5></center><br />
                   ...
                   <td> <a href="view_file1.jsp?<%=rs.getString("pmail")%>"><font style="color: green">View</a></font> </td>
