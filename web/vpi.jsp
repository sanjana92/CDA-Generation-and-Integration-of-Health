<%-- 
    Document   : vpi
    Created on : Jun 14, 2016, 3:25:26 PM
    Author     : java4
--%>
...
<div id="container" class="width">
	      ...
	      <%---menu start ---%>		
    			<ul class="sf-menu dropdown">
            			...
            			<li><a href="patient_re.jsp">Patient Information</a></li>
                                <li class="selected"><a href="vpi.jsp">View Information</a></li>
 ...
 <form action="result.jsp" method="get" >
       ...
       <input type="password" name="search" required="" placeholder="Secert Key"><br><br>
